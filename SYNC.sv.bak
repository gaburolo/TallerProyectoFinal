...
module SYNC(
	...
	printText t3(VGA_CLK_IN, text3, 335, 117, sx, sy, pixel3);
	printText t4(VGA_CLK_IN, text4, 335, 137, sx, sy, pixel4);
	printText t5(VGA_CLK_IN, text5, 335, 157, sx, sy, pixel5);
	printText t6(VGA_CLK_IN, text6, 335, 177, sx, sy, pixel6);
	printText t7(VGA_CLK_IN, text7, 335, 197, sx, sy, pixel7);
	printText t8(VGA_CLK_IN, text8, 335, 217, sx, sy, pixel8);
	printText t9(VGA_CLK_IN, text9, 335, 237, sx, sy, pixel9);
	printText t10(VGA_CLK_IN, text10, 335, 257, sx, sy, pixel10);
	printText t11(VGA_CLK_IN, text11, 335, 277, sx, sy, pixel11);
	printText t12(VGA_CLK_IN, text12, 335, 297, sx, sy, pixel12);
	printText t13(VGA_CLK_IN, text13, 335, 317, sx, sy, pixel13);
	printText t14(VGA_CLK_IN, text14, 335, 337, sx, sy, pixel14);
	printText t15(VGA_CLK_IN, text15, 335, 357, sx, sy, pixel15);
	printText t16(VGA_CLK_IN, text16, 335, 377, sx, sy, pixel16);
	printText t17(VGA_CLK_IN, text17, 335, 397, sx, sy, pixel17);
	printText t18(VGA_CLK_IN, text18, 335, 417, sx, sy, pixel18);
	printText t19(VGA_CLK_IN, text19, 335, 437, sx, sy, pixel19);
	printText t20(VGA_CLK_IN, text20, 335, 457, sx, sy, pixel20);
